...
The GM also gets a con artist's move: click a staked die on the pot line mid-game and swap it for a lookalike. The real die slips back to its owner, the stand-in takes its place, and the table keeps seeing the original name, with no log entry to betray the hand. Whether anyone noticed is yours to adjudicate; the winner finds out the honest way, when the pot lands in their inventory.
